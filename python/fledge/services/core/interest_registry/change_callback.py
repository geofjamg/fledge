        ...
        async with aiohttp.ClientSession() as session:
            try:
                ...
                async with session.post(url, data=data, headers=headers) as resp:
                    ...
                    print(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S') + " TOTO status code " + status_code, flush=True)
                ...
                print(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S') + " TOTO error " + ex, flush=True)
                print(ex)
